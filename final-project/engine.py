...
class ClusteringEngine:
    ...
    def __transform_model(self):
        ...
        """
        assembler = VectorAssembler(inputCols=["GEO_LAT", "GET_LON"], outputCol='features')
    ...
    def __init__(self, spark_session, dataset_path):
        ...
        if exist:
            ...
            self.df_crime1 = self.df_crime1.selectExpr("_c0 as INCIDENT_ID", "_c1 as GEO_LAT", "_c2 as GET_LON")
        ...
        if exist:
            ...
            self.df_crime2 = self.df_crime2.selectExpr("_c0 as INCIDENT_ID", "_c1 as GEO_LAT", "_c2 as GET_LON")
        ...
        if exist:
            ...
            self.df_crime3 = self.df_crime3.selectExpr("_c0 as INCIDENT_ID", "_c1 as GEO_LAT", "_c2 as GET_LON")
